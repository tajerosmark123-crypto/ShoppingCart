...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      addToast('Account created successfully! Welcome to GradCart!', 'success');
            ...
            <div className="p-8 md:p-10">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-400 mt-2 ml-1">At least 6 characters</p>
                </div>
                ...
                <div className="flex items-center gap-3 px-1 py-2">
                  <input 
                    ...
                    required 
                    disabled={isLoading}
                    className="h-4 w-4 rounded border-gray-300 text-maroon accent-maroon disabled:opacity-50 disabled:cursor-not-allowed" 
                  />
